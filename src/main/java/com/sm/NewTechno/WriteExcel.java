...
public class WriteExcel {
    ...
    public static void main(String[] args) {
        ...
        list.add(dataMap);
        writeExcel(list, 3, "/Users/justinniu/learn/test.xls");
...
//                commodity.setCommodityBarCode(1);
//                commodity.setCommodityId(2);
//                commodity.setCommodityName("牛肉");
//                commodity.setCommodityPrice("10");
//                commodity.setDiscountEndAt("1996");
//                commodity.setIsDiscount("1");
//                commodity.setDiscountStartAt("2018");
//                for (int i = 0; i < propertyName.size(); i++)
//                    System.out.println(propertyName.get(i) + "--" + methodList.get(i) );
////                propertyName.forEach(System.out::println);/**/
